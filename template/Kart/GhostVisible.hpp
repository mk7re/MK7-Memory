...
BEGIN_NAMESPACE(Kart)
{
    ...
    public:
        ...
        /START_STRUCT/NAME@SInfo/SIZE@0x14/
            ...
            /M/f32 m_ghost_alpha/0x4/0xC/
            /U/u8/0x1/0x10/
        /END/

        GhostVisible();
        void addKartInfo(s32, InfoProxy *);
        void init();
        void update();

        /M/InfoProxy *m_info_proxy/0x4/0x0/
        /M/Camera *m_camera/0x4/0x4/
        /M/sead::PtrArray<SInfo> m_entries/0xC/0x8/ // same type as 0xBC field
        /M/SInfo *m_last_info/0x4/0x14/
        /M/SInfo *m_info_pointer/0x4/0x18/
        /M/SInfo m_info_value[KART_MAX]/0xA0/0x1C/
        /M/SInfo *m_entries_buffer[KART_MAX]/0x20/0xBC/
